...
export function FilesView(props) {
    ...
    return React.createElement('div', { className: 'dshfm-root', 'data-conversation-composer-overlay': '' }, React.createElement('div', { className: 'dshfm-bar' }, React.createElement('button', { type: 'button', className: viewMode === 'files' ? 'dshfm-btn dshfm-btn-on' : 'dshfm-btn', onClick: () => setViewMode('files') }, '文件'), React.createElement('button', { type: 'button', className: viewMode === 'docker' ? 'dshfm-btn dshfm-btn-on' : 'dshfm-btn', onClick: () => setViewMode('docker') }, 'Docker'), viewMode === 'files' ? React.createElement(React.Fragment, null, React.createElement('button', { type: 'button', className: treeVisible ? 'dshfm-btn dshfm-btn-on' : 'dshfm-btn', title: '显示/隐藏目录', onClick: () => setTreeVisible((v) => !v) }, '☰'), React.createElement('span', { className: 'dshfm-path', title: state.root }, state.root || '—'), React.createElement('input', { className: 'dshfm-input', value: filter, placeholder: '筛选…', onChange: (e) => setFilter(e.target.value) }), React.createElement('button', { type: 'button', className: 'dshfm-btn', onClick: () => setReloadKey((k) => k + 1) }, '刷新'), React.createElement('button', { type: 'button', className: 'dshfm-btn', onClick: openRoot, disabled: state.root === '' }, '打开目录')) : null), React.createElement('div', { className: 'dshfm-main' }, viewMode === 'docker' ? React.createElement('div', { className: 'dshfm-docker-wrap' }, React.createElement(DockerPanel, { sessionId: sid })) : null, viewMode === 'files' && treeVisible ? React.createElement('div', { className: 'dshfm-tree' }, React.createElement('div', { className: 'dshfm-tree-head' }, React.createElement('button', { type: 'button', className: 'dshfm-btn dshfm-back', title: '返回上一级', disabled: currentPath === '', onClick: goUp }, '\u2190'), React.createElement('div', { className: 'dshfm-crumbs' }, renderCrumbs())), React.createElement('div', { className: 'dshfm-tree-body' }, treeBody)) : null, viewMode === 'files' ? React.createElement('div', { className: 'dshfm-preview' }, tabs.length > 0 ? React.createElement('div', { className: 'dshfm-tabs' }, renderTabs()) : null, React.createElement('div', { className: 'dshfm-preview-head' }, React.createElement('span', { className: 'dshfm-preview-name' }, activeTab === null ? '预览' : activeTab.name), activeTab === null ? null : React.createElement('span', { className: 'dshfm-preview-meta', title: activeTab.path }, activeTab.path + (activeDoc !== null && activeDoc.size > 0 ? ' · ' + fmtSize(activeDoc.size) : '')), React.createElement('span', { className: 'dshfm-preview-spacer' }), activeTab !== null && activeDoc !== null && activeDoc.kind === 'text' && isMarkdown(activeTab.name)
